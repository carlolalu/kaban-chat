...
```mermaid
flowchart TB
    wr_manager1 --"writes to"--> SERVER_handle_msgs_reader1 --"sends Messages to"-->client_tcp_rd_loop1
    client_tcp_wr_loop1 --"writes to"--> CLIENT_handle_msgs_reader1 --"sends Messages to"--> rd_manager1

    wr_manager2 --"writes to"--> SERVER_handle_msgs_reader2 -- "sends Messages to" -->client_tcp_rd_loop2
    client_tcp_wr_loop2 --"writes to"--> CLIENT_handle_msgs_reader2 --"sends Messages to"--> rd_manager2
    ...
    subgraph SERVER
        ...
        SERVER_handle_msgs_reader1
        SERVER_handle_msgs_reader2
    end
```
